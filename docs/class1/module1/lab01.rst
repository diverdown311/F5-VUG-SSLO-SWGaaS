...
-  The **Ubuntu18.04 Client** client is attached to a :red:`10.1.10.0/24` network
   and is assigned the IP :red:`10.1.10.50`. This network is attached to the
   BIG-IP :red:`1.1` interface.

-  The **L2 device** is consolidated onto the **Ubuntu18.04 Services** server configured to bridge its eth1
...
-  The **L3 device** is also the **Ubuntu18.04 Services** server configured to route between
...
-  The **TAP** device is the **Ubuntu18.04 Services** server configured with a single
   eth1 interface. That interface is attached to the BIG-IP :red:`1.7`
   interface.

-  The **DLP/ICAP** device is also the **Ubuntu18.04 Services** server configured with a
...
-  The **Explicit Proxy device** is the **Ubuntu18.04 Services** server configured with
